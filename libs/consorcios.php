...
if (!isset($_GET['filter']) || empty($_GET['filter'])) {
    header("Location: ./consorcios.php?filter=active");
    exit;
}
...
<head>
    ...
    <title>App Consumidora - Consorcios</title>
                ...
                <div class="dropdown-center">
                    ...
                    <ul class="dropdown-menu">
                        <li class="btn btn-md btn-<?php if ($_GET['filter'] == "all") {$color = "success";} else {$color = "dark";}?><?= $color ?>">
                            <a style="text-decoration: none; font-weight: bold;" class="text-light" href="./consorcios.php?filter=all">Todas as requisições</a>
                        </li>
                        <li class="btn btn-md btn-<?php if ($_GET['filter'] == "active") {$color = "success";} else {$color = "dark";}?><?= $color ?>">
                            <a style="text-decoration: none; font-weight: bold;" class="text-light" href="./consorcios.php?filter=active">Todas as requisições ativas</a>
                        </li>
                        <li class="btn btn-md btn-<?php if ($_GET['filter'] == "inactive") {$color = "success";} else {$color = "dark";}?><?= $color ?>">
                            <a style="text-decoration: none; font-weight: bold;" class="text-light" href="./consorcios.php?filter=inactive">Todas as requisições na lixeira</a>
                        </li>
                    </ul>
                </div>
                <hr class="mb-5">
                <?php if (count($results) == 0): ?>
                    <p class="text-center">Não existem Consorcios na base de dados</p>
                <?php else: ?>
                    <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a style="text-decoration: none;"
                                            ...
                                            class="btn btn-md btn-dark rounded text-info" title="vizualizar consorcio">
                                    ...
                                    <?php if ($result['deleted_at'] == null) { ?>
                                        <td>
                                            <a style="text-decoration: none;"
                                                ...
                                                class="btn btn-md btn-dark rounded text-danger" title="deletar consorcio">
                                                <span class="material-icons">
                                                    delete
                                                </span>
                                            </a>
                                    ...
                                    <?php } else { ?>
                                        <td>
                                            <a style="text-decoration: none;"
                                                ...
                                                class="btn btn-md btn-dark rounded text-warning" title="restaurar consorcio apagado">
                                                <span class="material-icons">
                                                    restart_alt
                                                </span>
                                            </a>
